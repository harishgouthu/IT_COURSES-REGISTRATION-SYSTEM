...
const AdminPasswordResetConfirm = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await axios.post(`http://localhost:8000/users/Adminpassword-reset/${uidb64}/${token}/`, { new_password: newPassword });
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-60">
            <div className="relative bg-white rounded-lg shadow-lg p-6 max-w-md w-full">
                <h2 className="text-xl font-semibold mb-4 text-blue-600 text-center">Reset Your AdminPassword</h2>
